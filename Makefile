...
CC      = gcc
INCLUDE = -I./include
CFLAGS  = -g -O2 -fdebug-prefix-map=/data/userbak/devel/sdlstuf/libsdl1.2-1.2.15=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2
EXTRA_CFLAGS = -I./include -D_GNU_SOURCE=1 -fvisibility=hidden  -D_REENTRANT  -DXTHREADS -I/usr/include/ -D_REENTRANT -DHAVE_LINUX_VERSION_H -Wall
LDFLAGS = -Wl,-z,relro
EXTRA_LDFLAGS =  -lm -ldl  -lasound -lm -ldl -lpthread -lpulse-simple -lpulse  -lX11 -lXext -lXrandr -lXrender -L/usr/lib/arm-linux-gnueabihf -lcaca -lts -lpthread
